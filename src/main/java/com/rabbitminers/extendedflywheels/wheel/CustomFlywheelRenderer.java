...
public class CustomFlywheelRenderer extends KineticTileEntityRenderer {
	public CustomFlywheelRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
	...
	protected void renderSafe(KineticTileEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		...
		CustomFlywheelTileEntity wte = (CustomFlywheelTileEntity) te;
